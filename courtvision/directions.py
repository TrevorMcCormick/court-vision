...
Lifted verbatim from experiments/shot_direction.py (2026-07-10) for
the courtvision package; the experiment script stays frozen as history.

Usage (from courtvision.chart):

    from courtvision import directions
