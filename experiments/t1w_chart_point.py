"""T1 — chart loop v2 on WASB tracks. Freeze #3: playable-envelope gate added
for dense tracks (see the HIT_CY_* constants block); all frozen-era constants
untouched.
...
def chart_clip(stem, Hm, serves):
    clip = ROOT / "clips/points_t1" / f"{stem}.mp4"
